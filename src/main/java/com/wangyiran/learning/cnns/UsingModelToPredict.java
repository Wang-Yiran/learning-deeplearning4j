...
public class UsingModelToPredict {
    ...
    public static final String absolutePath = "/Users/wangyiran/git/learning-deeplearning4j/src/main/resources/";
//    private static String modelPath = "model/LeNetModel.zip";
    private static String modelPath = "/Users/wangyiran/git/learning-deeplearning4j/src/main/resources/model/LeNetModel.zip";
...
//        File imgFile = new ClassPathResource("/mnist/4.jpg").getFile();
        File imgFile = new ClassPathResource("/mnist-images/7_819.bmp").getFile();
//        File imgFile = new ClassPathResource("/model/000.png").getFile();
...
//        System.out.println(imgNdarray);
         ...
         * 把灰度化之后的图片进行保存
         */
        ImageIO.write(imageFromINDArray(imgNdarray), "jpg", new File(absolutePath + "model/test.jpg"));
...
//        System.out.println(imageLoader.asMatrix(new File(absolutePath + "model/test.jpg")));
    }
